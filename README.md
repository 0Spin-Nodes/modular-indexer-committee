...
Modular Indexer relies on a running [OPI indexer 0.3.0](https://github.com/bestinslot-xyz/OPI/releases/tag/0.3.0)
...
- `gasCoupon`: Custom coupon for managing transaction fees.
